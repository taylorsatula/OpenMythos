...
> This file is the upstream [OpenMythos](https://github.com/kyegomez/OpenMythos) README preserved verbatim. It documents the architecture itself (the RDT hypothesis, MoE, MLA/GQA, LTI injection, ACT halting, the Claude Mythos theory). For the **training harness** built on top of this architecture in this fork, see [`README.md`](README.md) and [`HANDOFF.md`](HANDOFF.md).
